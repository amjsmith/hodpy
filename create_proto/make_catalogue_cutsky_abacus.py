...
if __name__ == '__main__':
    ...
    observer=(0,0,0) #coordinates of observer in the box. This is the corner
    ## THIS IS THE ORIGINAL observer=(-1000,-1000,-1000) #coordinates of observer in the box. This is the corner
    ...
    output_path = '/pscratch/sd/a/acarnero/codes/hodpy/make_mocks/test/z%.3f/AbacusSummit_base_c%03d_ph%03d/new/'%(snapshot_redshift,cosmo,phase)
    ...
    input_file = '/pscratch/sd/a/acarnero/BGS_box_ph000_with_coords0_v2.fits' #galaxy_snapshot_file%file_number
    output_file = '/pscratch/sd/a/acarnero/BGS_cutsky_v2.fits' #galaxy_cutsky%file_number
...
#loop through the periodic replications
    for i in range(-5,6):
        for j in range(-5,6):
            for k in range(-5,6):
                    ...
                    try:
                        table_i_rep = Table.read('/pscratch/sd/a/acarnero/BGS_cutsky_v2'+'_rep%i%i%i.fits'%(i,j,k))
    ...
    table_i.write('/pscratch/sd/a/acarnero/BGS_cutsky_v2.fits')    
